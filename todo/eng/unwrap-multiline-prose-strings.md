...
**2026-09-19, Fable (forward-port of mi-ni#90)** — Marimo was removed. `.devcontainer/marimo.toml` and report `mo.md()` cells are gone with it; the wrapping convention itself carries over unchanged to literate-script prose strings.
