...
**2026-09-08, ex-2.2.3 prereg** — not folded into ex-2.2.3. Its richer-op arm (E4) runs on the word grammar only, at one, three, and six ops, and this item needs the ex-2.1.5 two-form corpus on top of the op table. Deferred until the op table has landed and a two-form multi-op corpus is cheap to build.
